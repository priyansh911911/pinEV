...
const TransactionDetailsDrawer = ({ isOpen, onOpenChange, transaction }: TransactionDetailsDrawerProps) => {
	...
	return (
		<Drawer open={isOpen} onOpenChange={onOpenChange}>
			<DrawerContent className="max-h-[95%] default-page-width !w-full">
				<DrawerHeader className="sr-only">
					<DrawerTitle>Transaction Details</DrawerTitle>
					<DrawerDescription>Details of your transaction</DrawerDescription>
				</DrawerHeader>

				<div className="h-full overflow-y-auto pt-4 mb-6">
					{/* Header with Amount */}
					<div className={`p-6 ${transaction.type === "credit" ? "bg-primary/10" : "bg-destructive/10"}`}>
						<Badge variant={transaction.type === "credit" ? "default" : "destructive"} className="mb-4">
